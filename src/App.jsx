...
function App() {
    ...
    return (
        <div className='static h-[100%] bg-[#E2E1DF] '>
            <div className="flex gap-x-[20px] h-[60px] items-center p-[10px] bg-slate-700 opacity-60 text-white sticky   top-0 left-0 w-[100%] z-20 " >
                <a href="#home">Home</a>
